...
const Scroll = () => {
  return (
    <div className='flex justify-center py-20'>
        <div className='bg-[#252525] h-fit md:w-[65%] gap-8 w-full flex snap-x snap-mandatory overflow-x-auto p-4 pb-6 shadow-inner scrollbar-thin scrollbar-thumb-emerald-400 scrollbar-track-slate-700'>
